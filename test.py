...
"Prometheus/2.28.1" "87e3003d-bb9d-4b76-8ff8-d243780b9444" "172.16.147.14:8080" "172.16.147.14:8080" inbound|8080|| 
127.0.0.6:44234 172.16.147.14:8080 172.16.31.6:60392 - default """


class TestLogPasser(unittest.TestCase):

    #  test that the 2 objects are equal
    def test_run(self):
        self.assertEqual(
